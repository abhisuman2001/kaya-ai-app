...
fun QualityCategoryGridCard(
    ...
    onCategorySelected: (QualityCategory) -> Unit,
    ...
    Card(
        modifier = modifier
            ...
            .testTag("quality_category_grid_card"),
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            LazyRow(
                ...
                items(QualityCategory.values()) { category ->
...
private fun getCategoryIcon(category: QualityCategory): ImageVector {
    return when (category) {
        QualityCategory.ALL -> Icons.Default.Category
        QualityCategory.CRACKS -> Icons.Default.Architecture
        QualityCategory.SURFACE -> Icons.Default.FormatPaint
        QualityCategory.ALIGNMENT -> Icons.Default.Straighten
        QualityCategory.CONCRETE -> Icons.Default.WaterDrop
        QualityCategory.PIPE -> Icons.Default.Plumbing
        QualityCategory.BOLT -> Icons.Default.Build
    }
}
