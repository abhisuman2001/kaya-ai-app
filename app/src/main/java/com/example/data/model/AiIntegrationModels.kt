...
data class QdrantVectorRecord(
    val vectorId: String,
    val collectionName: String = "sitemind_blueprints_v2",
...
data class AiIntegrationState(
    ...
    val qdrantVectors: List<QdrantVectorRecord> = listOf(
        QdrantVectorRecord("vec_8820", "sitemind_blueprints_v2", 1536, 0.964f, "Level 18 Pour Schedule: Concrete placement restricted when ambient temp exceeds 95°F."),
