...
data class BackendServerStatus(
    ...
    val services: List<ContainerServiceStatus> = listOf(
        ContainerServiceStatus("sitemind_fastapi_app", "a8f3b21c", "fastapi:python3.11", "RUNNING", true, "8000:8000"),
        ContainerServiceStatus("sitemind_postgres_db", "92c101de", "postgres:16-alpine", "RUNNING", true, "5432:5432"),
        ContainerServiceStatus("sitemind_redis_cache", "42f778ab", "redis:7-alpine", "RUNNING", true, "6379:6379")
    )
)
